...
* 📊 Exibir o nível de precisão da previsão
...
```bash
git clone https://github.com/Trabalhos-UNIP-IA/Identificador_maiuscula_minuscula.git
```
...
```bash
primeiro: python modelo.py
depois: python interface_previsao.py
```
...
* Pressione **F** para falar palavra
* Pressione **R** para resetar palavra
* Pressione **Backspace** para remover última letra
